...
import {addNewIngredient, backButton,deleteIngredient,saveDish} from './Modules/forms.js';
...
document.addEventListener("DOMContentLoaded", function(){
    showDishes(0, "Normal"); //It will charge the normal mode at page 0 by default
    carousel();
 });
