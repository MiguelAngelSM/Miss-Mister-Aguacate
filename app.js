...
dishes[0] = new Dish("Plato 1", 10, "Plato delicioso", [], "Iconos/vegano.png");
dishes[1] = new Dish("Plato 2", 9, "Plato delicioso", [], "Iconos/vegano.png");
dishes[2] = new Dish("Plato 3", 8, "Plato delicioso", [], "Iconos/vegano.png");
dishes[3] = new Dish("Plato 4", 7, "Plato delicioso", [], "Iconos/vegano.png");
dishes[4] = new Dish("Plato 5", 6, "Plato delicioso", [], "Iconos/vegano.png");
...
function showDishes(dishes, page) {
    ...
    for (i = 0; i < 4; i++) {
        if (dishes[n + i]) {//undefined is false
            ...
            let img = document.getElementById("Image" + i);//Refresh Image
            img.innerHTML = '<img src ="Iconos/Plato.png" class="img-responsive" width="100%" height="100%"></img>'; //Prints a default image when there are no dishes
